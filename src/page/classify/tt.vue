<template>
  <div class="classify_page">
    <!--<head-top head-title="分类" go-back='true' ></head-top>-->
    <!--<div class="c_body">-->
    <!--<router-link to="/home" class="choose_position">-->
                    ...
                    <section v-for="(foods,foodindex) in item.foods" :key="foodindex" class="menu_detail_list">
                      ...
                      <div  tag="div" class="menu_detail_link">
                        ...
                        <section class="menu_food_description">
                          ...
                          <p class="food_description_content">{{goodsQuantity}}</p>
                      ...
                      <footer class="menu_detail_footer">
                        ...
                        <buy-cart :shopId='shopId' :foods='foods' @moveInCart="listenInCart"  @showReduceTip="showReduceTip" @showMoveDot="showMoveDotFun"></buy-cart>
                      </footer>
                    </section>
                  </li>
                </ul>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...mapMutations([
        'RECORD_ADDRESS','ADD_CART','REDUCE_CART','INIT_BUYCART','CLEAR_CART','RECORD_SHOPDETAIL', 'SAVE_GEOHASH'
      ]),
      //初始化时获取基本数据
      async initData(){
        if (!this.latitude) {
