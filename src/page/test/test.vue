  ...
  <div class="city_container">
    ...
    <form class="city_form" v-on:submit.prevent>
      <div>
        ...
        关键词：<input v-model='inputVaule' required  type="search" name="city" class="city_input input_style" placeholder="输入学校、商务楼、地址" >
      </div>
      <baidu-map @click="test">
        <bm-view class="map"></bm-view>
        <bm-local-search :keyword="inputVaule" :auto-viewport="true" :location="this.cityname"></bm-local-search>
      </baidu-map>
      <div>
...
<script>
  ...
  export default {
    ...
    methods:{
      test(tt){
        console.log(tt.bb.z.title);
        searchplace(this.cityid, tt.bb.z.title).then(res => {
      ...
      postpois(){
        //输入值不为空时才发送信息
        // console.log(typeof (this.inputVaule));
