<template>
    <div class="loginContainer">
        ...
        <form class="loginForm" v-else>
            <section class="input_container">
                <input type="text" placeholder="账号" value="18751076763" v-model.lazy="userAccount">
            </section>
            <section class="input_container">
                <input v-if="!showPassword" type="password" value="www" placeholder="密码"  v-model="passWord">
                <input v-else type="text" placeholder="密码" value="www"  v-model="passWord">
