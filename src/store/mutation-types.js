export const VENDING_POSITION = 'VENDING_POSITION'
...
export const VENDING_MESSAGE = 'VENDING_MESSAGE'//售货机信息
export const RECORD_MENU = 'RECORD_MENU'//商品信息
export const RECORD_CART = 'RECORD_CART'//购物车信息
export const RECORD_TOTALNUM = 'RECORD_TOTALNUM'//购物车信息
export const GET_CART = 'GET_CART'//购物车信息
export const RECORD_VENDINGPOSITION = 'RECORD_VENDINGPOSITION'//选择地址
export const WXUSERINFOSTATE = 'WXUSERINFOSTATE'//用户状态
